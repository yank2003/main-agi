...
const Contact = () => {
  return (
    <div className="w-full h-screen relative">
      ...
      {/* General Inquiries */}
      <div className="px-34 mt-5">
        <h1 className="brogman font-bold text-4xl">General inquiries</h1>
        <div className="mt-2 border-b-2 flex justify-between pb-10">
          <div>
            <h1 className="text-2xl font-extrabold">+91-123456789</h1>
            <h1 className="brogman">Toll free from all over India</h1>
          </div>
          <div>
            <h1 className="text-2xl font-extrabold">+91-123456789</h1>
            <h1 className="brogman">Toll free from all over India</h1>
          ...
          <div>
            <h1 className="text-3xl font-extrabold">Find a location</h1>
            <h1 className="brogman flex items-center">
              View our offices <MoveDown className="size-4" />
            </h1>
          </div>
        </div>
        <div>
      ...
      <div className="mt-10 h-[300px] flex text-white overflow-hidden px-30 gap-6">
        ...
        <div className="flex-1 bg-white text-black px-6 py-6 rounded-lg shadow-lg flex flex-col justify-between border border-black">
          <div className="space-y-4">
            <div>
              <h2 className="font-bold text-lg uppercase bower">Address</h2>
              <p className="mt-1 plasto tracking-wider">
                123 Business Street, Mumbai, India
              </p>
            </div>
            <div>
              <h2 className="font-bold text-lg uppercase bower">Email</h2>
              <p className="mt-1 plasto">xyz@gmail.com</p>
            </div>
            <div>
              <h2 className="font-bold text-lg uppercase bower">Phone</h2>
              <p className="mt-1 plasto">+91 98765 43210</p>
            </div>
          </div>
